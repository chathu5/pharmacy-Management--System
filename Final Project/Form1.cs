...
namespace E165243_Final_Project
{
    public partial class FrmLogin : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-8VD3OG40;Initial Catalog=""Skills Education"";Integrated Security=True");
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    FrmRegistration load = new FrmRegistration();
                    this.Hide();
                    load.Show();
                }
                else
